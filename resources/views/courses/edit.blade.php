                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('courses.update', $course) }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="price" class="block mt-1 w-full" type="number" name="price" :value="old('price', $course->price)" required step="0.01" />
                        ...
                        <div class="mt-4">
                            ...
                            @if ($course->thumbnail)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $course->thumbnail) }}" alt="{{ $course->title }}" class="w-32 h-32 object-cover">
                                </div>
                            @endif
                        </div>
